...
function orderProduct($number, $password) 
{
	...
	$url2 = "https://web.vodafone.com.eg/services/dxl/pim/product?relatedParty.id=01007060306&place.@referredType=Local&@type=MIProfile";
	$headers2 = [
	...
	$target_id = "MI_XC_CMBO_FlexActive_400";
	$enc_product_id = null;
